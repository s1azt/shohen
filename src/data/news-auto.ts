...
export const autoNews = [
  {
    ...
    "date": "2026.04.29",
    "category": "社内業務",
    "title": "  　【訂正・再送】新販売管理システム（OBIC7）移行に伴うパスワード設定およびID整理のお知らせ",
    "color": "text-red-500",
...
>>>>>>> 6f194f8d1c93d107e0ec26e81376c37403d1b8ee
  ...
  },
  {
    ...
    "title": "【要Chromeアクセス】重要度の高い脆弱性情報を更新しました(4/28 2件)",
    "color": "text-red-500",
  ...
  },
  {
    ...
    "date": "2026.04.28",
    "category": "セキュリティ/危機管理",
    "title": "(4/28新規) 【即時対応必須】ブラウザのアップデート実施をお願いします",
    "color": "text-red-500",
    "url": "http://tokyo.nekonet.co.jp/menu/pageout.aspx?key=Whats&url=https://drive.google.com/file/d/1Km7ODcqBxM54whHbJfLg02jglRDUn5KB/view?usp=sharing"
  },
  {
    "id": 1607416557,
    "date": "2026.04.28",
