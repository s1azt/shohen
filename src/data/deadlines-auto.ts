...
export const autoDeadlines: DeadlineItem[] = [
  {
    "id": 1637083036,
    "title": "Something企画を受付中！（4/3（金）まで）",
    "date": "2026.04.03",
    "updateDate": "2026.03.25",
    "url": "http://tokyo.nekonet.co.jp/menu/pageout.aspx?key=Whats&url=http://dominoap.nekonet.co.jp/all/all0088.nsf/($All)/4BBC0E3B483FD83549258DC500052647",
    "bg": "bg-[#fff5f5]",
